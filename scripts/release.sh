...
echo "Then run:"
echo "  git switch -c chore/release-v$NEW_VERSION"
echo "  git add pyproject.toml src/forage/__init__.py uv.lock CHANGELOG.md"
echo "  git commit -m 'chore: release v$NEW_VERSION'"
echo "  git push -u origin chore/release-v$NEW_VERSION"
echo "  gh pr create --base master --title 'chore: release v$NEW_VERSION' --body 'Prepare v$NEW_VERSION.'"
echo "After the pull request merges and CI passes on master:"
echo "  git switch master && git pull --ff-only origin master"
